...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Resync 2026-07-27: la línea del Reloj aplicó este MISMO fix en
        // 2026_07_11_120000_make_system_settings_key_unique_per_tenant (mismo bug de PK
        // global, mismas unicidades). Si su índice ya existe no hay nada que corregir —
        // y en SQLite el rebuild de abajo reventaría al recrear un nombre de índice que
        // sobrevive en la tabla renombrada (los nombres de índice son globales en SQLite).
        if (Schema::hasIndex('system_settings', 'system_settings_tenant_id_key_unique')) {
            return;
        }
