...
export default function AtsPortalSettings() {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-text-3 font-bold gap-3">
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
      ...
      <div className="lg:col-span-5 space-y-6">
        <div className="bg-white rounded-3xl border border-border shadow-sm overflow-hidden flex flex-col">
          ...
          <div className="p-6 border-b border-border flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-text-1 text-lg">Configuración de Bolsa de Trabajo</h3>
              <p className="text-text-3 text-xs mt-0.5">Personaliza y gestiona tu portal público de vacantes.</p>
            </div>
          </div>

          {/* Sub-Tabs de Formulario */}
          <div className="flex border-b border-border bg-page/50">
            <button
              type="button"
              onClick={() => setActiveFormTab('basico')}
              className={`flex-1 text-center py-3 text-xs font-bold border-b-2 transition-all ${activeFormTab === 'basico' ? 'border-accent text-accent bg-white font-extrabold' : 'border-transparent text-text-3 hover:text-text-2 hover:bg-page/50'}`}
            >
              Ajustes Básicos
            </button>
            <button
              ...
              className={`flex-1 text-center py-3 text-xs font-bold border-b-2 transition-all ${activeFormTab === 'diseno' ? 'border-accent text-accent bg-white font-extrabold' : 'border-transparent text-text-3 hover:text-text-2 hover:bg-page/50'}`}
            >
          ...
          <form onSubmit={handleSave} className="p-6 space-y-5">
            {activeFormTab === 'basico' ? (
              <>
                ...
                <div className="flex items-center justify-between p-4 bg-page rounded-2xl border border-border">
                  <div className="text-left pr-2">
                    <span className="block font-bold text-text-1 text-sm">Habilitar Portal Web</span>
                ...
                <div className="space-y-1.5">
                  <label className="block text-xs font-bold text-text-2 uppercase tracking-wider pl-1">Ruta del Enlace (Slug)</label>
                  <div className="flex rounded-xl overflow-hidden border border-border shadow-sm focus-within:border-accent focus-within:ring-1 focus-within:ring-focus-ring">
                    <span className="bg-page text-slate-400 text-xs px-3 flex items-center border-r border-border select-none font-mono">
                      /vacantes/
                    </span>
                    <input
                      type="text"
                      ...
                      className="w-full px-3 py-2.5 text-text-1 text-sm focus:outline-none font-mono"
                ...
                {/* Logotipo URL */}
                <div className="space-y-1.5">
                  <label className="block text-xs font-bold text-text-2 uppercase tracking-wider pl-1 flex items-center gap-1.5">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 mt-2">
                    ...
                    <input
                      ...
                      value={settings.brand_color}
                      onChange={(e) => setSettings({ ...settings, brand_color: e.target.value })}
                      className="w-full px-3 py-1.5 rounded-lg border border-border text-text-1 text-xs font-mono"
                      placeholder="#8b5cf6"
                    />
                  </div>
                </div>
              ...
              <>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-1.5 pl-1 border-l-2 border-accent">
                    <span className="text-xs font-bold text-accent uppercase tracking-wide">Banner Superior (Hero)</span>
                  </div>

                  <div className="space-y-1.5">
                    <label className="block text-[11px] font-bold text-text-3 uppercase tracking-wide pl-1">Título del Banner</label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-1.5">
                    <label className="block text-[11px] font-bold text-text-3 uppercase tracking-wide pl-1">Subtítulo del Banner</label>
                    <textarea
                      value={settings.custom_settings.header_subtitle}
                      onChange={(e) => handleCustomSettingChange('header_subtitle', e.target.value)}
                      className="w-full px-4 py-2 rounded-xl border border-border shadow-sm text-text-1 text-sm focus:outline-none focus:ring-1 focus-visible:ring-focus-ring focus:border-accent h-16 resize-none"
                      placeholder="No solo ofrecemos trabajo, construimos carreras. Encuentra tu lugar en nuestra familia."
                    />
                  </div>

                  <div className="space-y-1.5">
                    <label className="block text-[11px] font-bold text-text-3 uppercase tracking-wide pl-1 flex items-center gap-1">
                ...
                <div className="space-y-4 pt-2 border-t border-border">
                  <div className="flex items-center gap-1.5 pl-1 border-l-2 border-accent">
                    <span className="text-xs font-bold text-accent uppercase tracking-wide">Pie de Página (Footer)</span>
                  </div>

                  <div className="space-y-1.5">
                    <label className="block text-[11px] font-bold text-text-3 uppercase tracking-wide pl-1">Texto de Copyright</label>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      <label className="block text-[11px] font-bold text-text-3 uppercase tracking-wide pl-1 flex items-center gap-1"><Mail size={11}/> Correo</label>
                      <input
                        type="email"
                        value={settings.custom_settings.contact_email}
                        onChange={(e) => handleCustomSettingChange('contact_email', e.target.value)}
                        className="w-full px-3 py-2 rounded-xl border border-border shadow-sm text-text-1 text-xs focus:outline-none focus:ring-1 focus-visible:ring-focus-ring focus:border-accent"
                        placeholder="contacto@empresa.com"
                      />
                    </div>
                    <div className="space-y-1.5">
                      <label className="block text-[11px] font-bold text-text-3 uppercase tracking-wide pl-1 flex items-center gap-1"><Phone size={11}/> Teléfono</label>
                      <input
                        type="text"
                  ...
                  <div className="space-y-2">
                    <label className="block text-[11px] font-bold text-text-3 uppercase tracking-wide pl-1">Redes Sociales (Enlaces)</label>
                    <div className="space-y-2">
                      <div className="flex rounded-xl overflow-hidden border border-border shadow-sm focus-within:border-accent focus-within:ring-1 focus-within:ring-focus-ring">
                        <span className="bg-page text-slate-400 px-3 flex items-center border-r border-border"><Facebook size={12}/></span>
                        <input
                          type="url"
                          value={settings.custom_settings.social_facebook}
                          onChange={(e) => handleCustomSettingChange('social_facebook', e.target.value)}
                          className="w-full px-3 py-2 text-text-1 text-xs focus:outline-none"
                          placeholder="https://facebook.com/pagina"
                        />
                      </div>
                      <div className="flex rounded-xl overflow-hidden border border-border shadow-sm focus-within:border-accent focus-within:ring-1 focus-within:ring-focus-ring">
                        <span className="bg-page text-slate-400 px-3 flex items-center border-r border-border"><Instagram size={12}/></span>
                        <input
                          type="url"
                      ...
                      <div className="flex rounded-xl overflow-hidden border border-border shadow-sm focus-within:border-accent focus-within:ring-1 focus-within:ring-focus-ring">
                        <span className="bg-page text-slate-400 px-3 flex items-center border-r border-border"><Linkedin size={12}/></span>
                        <input
                          type="url"
            ...
            <button
              ...
              className={`w-full py-3 rounded-xl font-bold text-sm transition-all flex justify-center items-center gap-2 shadow-sm ${
                hasChanges
                  ...
                  : 'bg-page text-slate-450 border border-border cursor-not-allowed'
              }`}
            >
        ...
        <div className="bg-white rounded-3xl p-6 border border-border shadow-sm space-y-5">
          <div className="flex items-center gap-2 text-text-1 font-bold text-sm border-b border-border pb-3">
              ...
              <div className="flex items-center justify-between bg-white px-3 py-2 rounded-xl border border-border gap-2 overflow-hidden">
                ...
                <div className="flex gap-1.5 shrink-0">
                  <button
                    ...
                    className="p-2 bg-page hover:bg-navy-50 hover:text-accent text-text-3 rounded-lg border border-border transition-all"
                    title="Copiar Enlace"
                  >
                  ...
                  <a
                    ...
                    className="p-2 bg-page hover:bg-navy-50 hover:text-accent text-text-3 rounded-lg border border-border transition-all flex items-center justify-center"
      ...
      <div className="lg:col-span-7 space-y-4 flex flex-col">
        ...
        <div className="bg-white border border-border rounded-3xl overflow-hidden shadow-md flex-grow flex flex-col min-h-[500px]">
          {/* Cabecera del Simulador */}
          <div className="bg-page border-b border-border px-4 py-3 flex items-center gap-2 shrink-0 select-none">
          ...
          <div className="flex-grow overflow-y-auto p-6 bg-page relative max-h-[70vh]">
            <WebPublica
