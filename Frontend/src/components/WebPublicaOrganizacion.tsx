...
export function WebPublicaOrganizacion() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center p-4 sm:p-6 md:p-8 select-text font-serif relative overflow-hidden" 
      style={{
          ...
          {!isOpen ? (
            ...
            >
              ...
              >
                ...
                {showAiAssistant && (
                  <div className="absolute inset-0 bg-black/70 backdrop-blur-sm z-35 flex items-center justify-center p-4">
                    <div className="bg-[#f7f2e5] w-full max-w-md rounded-3xl p-6 relative border-4 border-[#b38728] shadow-2xl flex flex-col text-left">
                      <GoldenCorners />
                      ...
                      {/* Title */}
                      <h3 className="font-serif text-lg font-black text-[#3d1b13] border-b border-[#dcd1b3] pb-2 mb-4 flex items-center gap-2">
                        <Sparkles size={18} className="text-[#b38728]" />
                        Oráculo DecorArte: Asistente de Voz
                      </h3>
                      ...
                      {/* AI Answer */}
                      {(queryingAi || aiAnswer) && (
                        <div className="bg-[#faf6eb] border border-[#d2c7ac] rounded-2xl p-4 flex-1 overflow-y-auto max-h-[180px] scrollbar-none relative">
                      ...
                      {/* Tip / Footer */}
                      <div className="text-[9px] text-[#3d1b13]/40 font-sans font-bold border-t border-[#dcd1b3] pt-2 mt-4 text-center">
                      ...
                      {activeDoc ? (
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col text-left">
                            ...
                            <span className="text-xs font-bold text-[#3d1b13] font-sans truncate max-w-[120px] sm:max-w-[200px]">{activeDoc.title}</span>
                          </div>
                        </div>
                      ) : (
                          ...
                          <button
                            ...
                            className={`p-1.5 rounded-lg border transition-all flex items-center gap-1 text-[10px] font-sans font-bold shadow-sm ${
                              isSpeaking 
                                ...
                                : 'bg-[#faf6eb] border-[#d2c7ac] text-[#3d1b13] hover:bg-white'
                            }`}
