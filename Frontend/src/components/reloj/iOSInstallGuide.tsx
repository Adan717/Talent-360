    ...
    <div className="fixed bottom-4 left-4 right-4 z-[99] bg-slate-900/95 backdrop-blur border border-slate-700 text-white rounded-3xl p-5 shadow-2xl animate-fade-in-up flex flex-col gap-4 pointer-events-auto">
      ...
      <div className="flex justify-between items-start">
        <div className="flex items-center gap-3">
          <div className="w-12 h-12 bg-accent rounded-2xl flex items-center justify-center text-2xl shadow-md border border-navy-300/30">
            ⏳
          </div>
          <div>
      ...
      <div className="flex flex-col gap-3.5 text-[11px] border-t border-slate-800 pt-3.5">
        <div className="flex items-center gap-3">
          ...
          <p className="text-slate-300 flex-1 leading-relaxed">
            Presiona el botón de **Compartir** <Share2 className="w-3.5 h-3.5 inline mx-0.5 text-navy-300" /> en Safari.
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <p className="text-slate-300 flex-1 leading-relaxed">
            Desplázate y selecciona **"Añadir a la pantalla de inicio"** <PlusSquare className="w-3.5 h-3.5 inline mx-0.5 text-success-text" />.
          </p>
        </div>
