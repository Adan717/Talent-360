...
// (localInput hardcodeado a 'evidencia_checador_foto.jpg', sin cámara real) — se reusa
// exactamente el patrón ya probado en MealPhotoCapture.tsx (§23): getUserMedia, canvas,
// JPEG comprimido como data URL. El backend recibe ese mismo data URI en
// evidence_photo_base64, tanto para completar la tarea normal (assistantData) como para
// POST /task-assignments/{id}/ai-validate cuando la tarea usa validationMode: 'ai_comparison'.

interface TaskEvidenceCaptureProps {
  title?: string;
...
export default function TaskEvidenceCapture({ title = 'Evidencia Fotográfica de la Tarea', onCapture, onCancel, submitting = false }: TaskEvidenceCaptureProps) {
