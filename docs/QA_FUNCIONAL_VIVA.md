...
| ACC-09 | Entrar con Google usando una cuenta de empresa, no el superadmin. | Vincula/crea la cuenta correcta, abre su flujo correspondiente y no expone tokens en la URL. | PENDIENTE | 2026-09-11: primera prueba FALLÓ por `SESSION_DOMAIN` apuntando a la IP. Corregido y desplegado en `03676a9`; cookie host-only y canje del desafío verificados contra el servidor. Falta repetir con Google real. |
